...
{{< note >}}
Learn more about [ABAC](/platform/rkvst-basics/managing-access-to-an-asset-with-abac/) and [OBAC](/platform/rkvst-basics/sharing-assets-with-obac/) policies in our RKVST Basics guides.
{{< /note >}}
