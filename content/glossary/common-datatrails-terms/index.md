...
| [Merkle Mountain Range (MMR)](/developers/developer-patterns/navigating-merklelogs/) | As the massifs grow and multiply, we call the structure a MMR. Its key characteristic is that previously added values, and also the organization of those values, does not change as new entries are appended to the log |
