...
For more information on creating Events, please visit [Creating an Event Against an Asset](/platform/rkvst-basics/creating-an-event-against-an-asset/).
...
```
{{< note >}}
**Note** - The Event must be recorded against the appropriate `assets/<asset-id>` when the curl command is executed. [See Step 4 here for more details.](/platform/rkvst-basics/creating-an-event-against-an-asset/)
{{< /note >}}
